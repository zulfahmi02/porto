...
<body>
    ...
    <section id="home" class="hero-section">
        <div class="hero-content">
            ...
            <h1 class="hero-title">Hai, Saya <span class="typing-container"><span class="typing-text gradient-text" data-wait="3000" data-words='["Fahmi", "Zulfahmi Hidayatulloh"]'></span></span></h1>
            <p class="hero-role">Web Developer</p>
            <p class="hero-description">Selamat datang di dashboard portfolio saya. Halaman ini menyajikan ringkasan proyek, keterampilan, dan pengalaman yang telah saya kerjakan.</p>
            ...
            <div class="social-links">
                ...
                <a href="https://linkedin.com/in/zulfahmi-hidayatulloh-220975392" class="social-icon" aria-label="LinkedIn">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="container">
            ...
            <div class="about-content">
                <p class="about-description">
                    Saya adalah seorang web developer yang berkomitmen untuk membangun pengalaman digital yang luar biasa. Dengan pengetahuan yang solid tentang React, Node.js, dan teknologi web modern, saya mengubah ide-ide menjadi aplikasi yang fungsional dan cantik.
                </p>
            </div>
    ...
    <section id="projects" class="projects-section">
        <div class="container">
            ...
            <p class="section-description">
                Berikut adalah proyek-proyek yang saya kerjakan. Setiap proyek dirancang untuk memberikan gambaran jelas mengenai pendekatan kerja, kemampuan teknis, dan nilai yang dapat saya berikan dalam setiap kolaborasi.
            </p>

            <div class="projects-carousel">
                <div class="coming-soon-placeholder" style="text-align: center; padding: 3rem; background: rgba(255, 255, 255, 0.05); border-radius: 20px; border: 1px border: 1px solid rgba(255, 255, 255, 0.1);">
                    ...
                    <div class="carousel-track">
                        ...
                        <div class="project-card">
                            <div class="project-image">
                                @if($project->image)
                                    @if(str_starts_with($project->image, 'project'))
    ...
    <section id="contact" class="contact-section">
        <div class="container">
            ...
            <p class="section-description">
                Saya terbuka untuk diskusi proyek baru, ide kreatif, atau kesempatan untuk menjadi bagian dari visi Anda. Jangan ragu untuk menghubungi saya!
            </p>
            ...
            <div class="contact-cards">
                ...
                <a href="https://www.linkedin.com/in/zulfahmi-hidayatulloh-220975392?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" class="contact-card">
                    <svg class="contact-icon" width="48" height="48" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
